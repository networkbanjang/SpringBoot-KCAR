...
function textChange() {
	if (req.readyState == 4 && req.status == 200) {
		...
		data += "<li><div class='centerVisual'><span class='centerNameTag' id='tagname'></span> <img id='tagimg' src='${sessionScope.st_photo}' style='cursor: pointer;'> 	</div>"
		data += "<div class='centerInfo' id='tagaddr'> <p></p> <p class='centerTel' id='tagtel'></p> <p class='rentcarNum'> 직영점 차량 <a href='javascript:void(0);' class='pointColor'>149대</a> </p>"
		data += "<div class='mt32'> <button type='button' class='el-button el-button--button' onclick='mapstartsearch()';> <span> 찾아오시는 길 </span> </button> <button type='button' class='el-button el-button--button'>";
		data += "<span> 주소문자받기 </span> </button> </div> </div></li> </ul> "
