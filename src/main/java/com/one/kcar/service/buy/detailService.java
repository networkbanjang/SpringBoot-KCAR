...
//email content
	private String bodyHtml(String name,String emailContent, CarDTO car, CarOptionDTO carOption,CarTagDTO carTag, PaymentVO paymentVo, StoreDTO store) {
		String bodyHtml = "<div id=\"readFrame\">\r\n"
				...
				+ "										<span\r\n"
				+ "										style=\"font-size: 22px; font-weight: bold; color: #b70f28; letter-spacing: -0.4px;\">"+name+"</span>님께\r\n"
				+ "										보내신 차량정보입니다.\r\n"
				+ "								</span></td>\r\n"
				+ "							</tr>\r\n"
				+ "							<tr>\r\n"
				...
				+ "											style=\"font-weight: bold; color: #b70f28; font-size: 30px;\">"+car.getC_price()+"</strong>만원\r\n"
				...
				+ "							style=\"color: #b70f28; float: right;\">"+paymentVo.getSum()+"원</span>\r\n"
				+ "					</p>\r\n"
				+ "					<div\r\n"
				...
				+ "						<p>\r\n"
				+ "							<span style=\"\">차량가</span> <span style=\"float: right;\">"+paymentVo.getCarPrice()+"원</span>\r\n"
				+ "						</p>\r\n"
				+ "						<p style=\"padding-top: 8px\">\r\n"
				+ "							<span style=\"\">세금 및 부대비용</span> <span style=\"float: right;\">"+(paymentVo.getSum()-paymentVo.getCarPrice())+"</span>\r\n"
				+ "						</p>\r\n"
				+ "					</div>\r\n"
				+ "				</div>\r\n"
				+ "				<!-- 차량 기본 정보 -->\r\n"
