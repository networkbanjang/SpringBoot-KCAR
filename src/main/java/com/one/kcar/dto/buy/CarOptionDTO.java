...
public class CarOptionDTO {
	...
	public void setC_o_sonRoof(String c_o_sonRoof) {
		if(c_o_sonRoof != null || c_o_sonRoof.equals("0") == false) optionList.add(c_o_sonRoof);
	...
	public void setC_o_hiPass(String c_o_hiPass) {
		if(c_o_sonRoof != null || c_o_hiPass.equals("0")  == false) optionList.add(c_o_hiPass);
	...
	public void setC_o_backSensor(String c_o_backSensor) {
		if(c_o_sonRoof != null || c_o_backSensor.equals("0")  == false) optionList.add(c_o_backSensor);
	...
	public void setC_o_camera(String c_o_camera) {
		if(c_o_sonRoof != null || c_o_camera.equals("0")  == false) optionList.add(c_o_camera);
	...
	public void setC_o_navigation(String c_o_navigation) {
		if(c_o_sonRoof != null || c_o_navigation.equals("0") == false) optionList.add(c_o_navigation);
	...
	public void setC_o_handleHot(String c_o_handleHot) {
		if(c_o_sonRoof != null || c_o_handleHot.equals("0") == false) optionList.add(c_o_handleHot);
	...
	public void setC_o_airback(String c_o_airback) {
		if(c_o_sonRoof != null || c_o_airback.equals("0") == false) optionList.add(c_o_airback);
	...
	public void setC_o_smartKey(String c_o_smartKey) {
		if(c_o_sonRoof != null || c_o_smartKey.equals("0") == false) optionList.add(c_o_smartKey);
	...
	public void setC_o_blackBox(String c_o_blackBox) {
		if(c_o_sonRoof != null || c_o_blackBox.equals("0") == false) optionList.add(c_o_blackBox);
