...
<meta data-n-head="ssr" data-hid="title" name="title" content="렌트지점">
...
<body>
		...
		<div id="__layout">
			<div id="app" class="Container">
				...
				<div class="rentArea rentWrap contWrap">
					<div class="hsBanner keyVisual3">
						<p class="title">렌트지점</p>
						<p class="desc">
							신차에서 중고차까지<br> 렌트 전문 지점에서 최상의 서비스를 만나보세요
						</p>
					</div>
					<div class="rentCenter">
						<div class="el-row">
							<div class="subHeader pt64">
								<h1 class="title">렌트지점 안내</h1>
								<p class="desc">렌터카 상담이 필요한 고객님께 가까운 지점을 안내해 드립니다.</p>
							</div>
						</div>
						<div class="el-row">
							<ul class="linkToBox">
								<li><a href="#kcarRentC0061">서울역지점<span class="pointC">+
											기사포함렌트전문</span></a></li>
								<li><a href="#kcarRentC0062">K Car 렌트 사업부문<!----></a></li>
								<li><a href="#kcarRentC0001">대전지점<!----></a></li>
							</ul>
						</div>
						<div class="el-row">
							<section>
									...
									<div>
										<ul class="centerInfo">
											<li><strong>지점주소</strong>
												<p>서울특별시 용산구 한강대로 372 (동자동, KDB생명) KDB생명타워 B1 102호</p></li>
											<li><strong>대표번호</strong>
												<p>02-2231-3719</p></li>
											<li><strong>팩스번호</strong>
												<p>02-518-1565</p></li>
											<li><strong>영업시간</strong>
												<p>월~금요일 09:00~18:00 / 점심시간 12:00~13:00</p></li>
											<li><strong>휴무일</strong>
												<p class="pointC">공휴일/일요일/토요일 휴무</p></li>
											<li><strong>주요업무</strong>
												<p>
													중고차/신차 장기렌트 상담 및 계약, VIP차량의전, 웨딩카, 기타 기사포함렌트<span
														class="dot">지점에 따라 업무 내용이 다를 수 있으니 방문 전 전화 문의
														부탁드립니다</span>
												</p></li>
										</ul>
										<div class="btnBox">
											<button type="button"
												class="el-button quickSearch el-button--default">
												<!---->
												<!---->
												<span> 빠른길 찾기 </span>
											</button>
							...
							<section>
								...
								<div class="infoBox">
									...
									<div>
										<ul class="centerInfo">
											<li><strong>지점주소</strong>
												<p>서울특별시 중구 청계천로 100 (수표동, 시그니쳐타워) 서관 6층</p></li>
											<li><strong>대표번호</strong>
												<p>1588 5455</p></li>
											<li><strong>팩스번호</strong>
												<p>02-2231-3721</p></li>
											<li><strong>영업시간</strong>
												<p>월~금요일 09:00~18:00 / 점심시간 12:00~13:00</p></li>
											<li><strong>휴무일</strong>
												<p class="pointC">공휴일/토요일/일요일 휴무</p></li>
											<li><strong>주요업무</strong>
												<p>
													중고차 신차 장기렌트 상담 및 계약<span class="dot">지점에 따라 업무 내용이
														다를 수 있으니 방문 전 전화 문의 부탁드립니다</span>
												</p></li>
										</ul>
										<div class="btnBox">
											<button type="button"
							...
							<section>
								...
								<div class="infoBox">
									...
									<div>
										<ul class="centerInfo">
											<li><strong>지점주소</strong>
												<p>대전광역시 유성구 온천로 45 (봉명동, 유성푸르지오시티) 213호</p></li>
											<li><strong>대표번호</strong>
												<p>042-636-3651</p></li>
											<li><strong>팩스번호</strong>
												<p>042-621-3733</p></li>
						...
						<div>
							<div class="el-dialog__wrapper popup popCenter rentSmsPopup"
								style="display: none;">
								<div role="dialog" aria-modal="true" aria-label="렌트지점 정보문자 받기"
									class="el-dialog" style="margin-top: 15vh;">
									<div class="el-dialog__header">
										<span class="el-dialog__title">렌트지점 정보문자 받기</span>
										<button type="button" aria-label="Close"
											class="el-dialog__headerbtn">
											<i class="el-dialog__close el-icon el-icon-close"></i>
										</button>
	...
	<div class="el-menu--horizontal gnbSubMenu typeCenter1"
		style="position: absolute; top: 104px; left: 383px; z-index: 2028; display: none;"
		...
		<ul role="menu"
			...
			<li role="menuitem" tabindex="-1"
				class="el-menu-item menuItem is-active">렌트지점</li>
			<li role="menuitem" tabindex="-1" class="el-menu-item menuItem">
				렌트일반정비소</li>
			<li role="menuitem" tabindex="-1" class="el-menu-item menuItem">
				렌트사고정비소</li>
