																			...
																			<div
																				...
																				<div class="el-table__header-wrapper">
																					<table cellspacing="0" cellpadding="0" border="0"
																						...
																						<colgroup>
																							<col name="el-table_35_column_104" width="50">
																							<col name="el-table_35_column_105" width="685">
																							<col name="el-table_35_column_106" width="170">
																							<col name="gutter" width="0">
																						</colgroup>
																						<thead class="has-gutter">
																							<tr class="">
																								<th colspan="1" rowspan="1"
																									class="el-table_35_column_104   el-table-column--selection  is-leaf el-table__cell"><div
																										class="cell">
																								...
																								<th colspan="1" rowspan="1"
																									class="el-table_35_column_105     is-leaf el-table__cell"><div
																										class="cell"></div></th>
																								<th colspan="1" rowspan="1"
																									class="el-table_35_column_106     is-leaf el-table__cell"><div
																										class="cell"></div></th>
												...
												<div class="contentsBox section01  el-row">
													<div class="board">
														<div class="el-row">
															...
															<div class="boardStatus">
																<p class="total">
																	전체 <span class="pointColor">0</span> 건
																</p>
																<ul class="sorting">
																		...
																		<div
																			...
																			<div class="el-table__header-wrapper">
																				<table cellspacing="0" cellpadding="0" border="0"
																					class="el-table__header" style="width: 905px;">
																					<colgroup>
																						<col name="el-table_36_column_107" width="50">
																						<col name="el-table_36_column_108" width="685">
																						<col name="el-table_36_column_109" width="170">
																						<col name="gutter" width="0">
																					</colgroup>
																					<thead class="has-gutter">
																						<tr class="">
																							<th colspan="1" rowspan="1"
																								class="el-table_36_column_107   el-table-column--selection  is-leaf el-table__cell"><div
																									class="cell">
																									<label class="el-checkbox is-disabled"><span
																										class="el-checkbox__input is-disabled"><span
																											class="el-checkbox__inner"></span><input
																							...
																							<th colspan="1" rowspan="1"
																								class="el-table_36_column_108     is-leaf el-table__cell"><div
																									class="cell"></div></th>
																							<th colspan="1" rowspan="1"
																								class="el-table_36_column_109     is-leaf el-table__cell"><div
																									class="cell"></div></th>
																							<th class="el-table__cell gutter"
																								style="width: 0px; display: none;"></th>
																						</tr>
